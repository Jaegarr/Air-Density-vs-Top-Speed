...
RPM_max = 15000;    % Maximum engine speed [RPM], used the rev limiter value from Article xxx
...
P_MGUK_2026 = 200e3;    % MGU-K power limit 2026 [W]

% Vehicle Characteristics 
CdA     = 0.90; % Drag coefficient × frontal area [m^2]
Crr     = 0.01;  % Rolling resistance coefficient, this value is taken from my SAE publication
...
for i = 1:n
    ...
    % Total peak power [W]
    P_tot_2025(i) = P_ICE(i) + P_MGUK_2025;
    P_tot_2026(i) = P_ICE(i) + P_MGUK_2026;
    % Solve for top speed [m/s]: P = F_drag + F_rr * v
    f_speed = @(v,P) 0.5 * rho(i) * CdA * v.^3 + Crr * mass * g * v - P;
